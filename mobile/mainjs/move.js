...
$(document).ready(function() {
  ...
  var position=0; //갤러리 무비의 left값 0 -2000 -4000 -6000
  var onoff=true; // true=>타이머 동작중 , false=>동작하지 않을때
    
     $('.btn1').css('background','#ff9900'); //첫번째 불켜
    $('.btn1').css('width','30');
 ...
 function moveg(){
      ...
      $('.btn'+cnt).css('background','#ff9900');//자신만 불켜
  ...
  timeonoff= setInterval( moveg , 5000); //5초마다 자동기능 
  ...
  $('.mbutton').click(function(event){  //각각의 버튼을 클릭한다면...
    ...
    $('.btn'+cnt).css('background','#ff9900');//자신 버튼만 불켜 
    $('.btn'+cnt).css('width','30');
